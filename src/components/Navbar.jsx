      ...
      <div className="navbar-container">
        ...
        <nav className="navbar-pill">
          ...
          <div className="nav-right desktop-only">
            ...
            <a href="https://wa.me/94768118491" target="_blank" rel="noreferrer" className="contact-btn whatsapp-btn">
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="mobile-contact-info">
              <a href="https://wa.me/94768118491" target="_blank" rel="noreferrer" className="mobile-call-btn">
