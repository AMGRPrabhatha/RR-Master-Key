...
const Shop = () => {
  ...
  const cars = [
    ...
    { name: 'Honda Vezel RX', model: '2026 Luxury Sport', img: '/cars/honda_vezel_rx.png', brand: 'Honda', bodyStyle: 'SUV' },
    { name: 'Honda Fit RS', model: '2026 Sport Package', img: '/cars/honda_fit_rs.png', brand: 'Honda', bodyStyle: 'Hatchback' },
