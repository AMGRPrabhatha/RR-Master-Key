...
const Shop = () => {
  ...
  const cars = [
    ...
    { name: 'Honda Vezel Z Play', model: '2026 Active Package', img: '/cars/honda_vezel_z_play.png', brand: 'Honda', bodyStyle: 'SUV' },
    { name: 'Honda Vezel Z', model: '2026 Luxury Sport', img: '/cars/honda_vezel_rx.png', brand: 'Honda', bodyStyle: 'SUV' },
    { name: 'Honda Fit RS', model: '2026 Sport Package', img: '/cars/honda_fit_rs_black.png', brand: 'Honda', bodyStyle: 'Hatchback' },
    { name: 'Honda Fit', model: '2026 Hatchback', img: '/cars/honda_fit.png', brand: 'Honda', bodyStyle: 'Hatchback' },
    ...
    { name: 'Wagon R ZL', model: '2026 Compact Hatch', img: '/cars/wagon_r_zl.png', brand: 'Suzuki', bodyStyle: 'Hatchback' },
    { name: 'Suzuki Swift', model: '2026 Compact Hatch', img: '/cars/suzuki_swift.png', brand: 'Suzuki', bodyStyle: 'Hatchback' },
    { name: 'Suzuki Swift RX', model: '2026 Sport Hatch', img: '/cars/suzuki_swift_rx.png', brand: 'Suzuki', bodyStyle: 'Hatchback' },
    { name: 'Suzuki Spacia Custom Z', model: '2026 Micro-Van', img: '/cars/suzuki_spacia_custom_z.png', brand: 'Suzuki', bodyStyle: 'Hatchback' },
    
    // Toyota Updates
    { name: 'Toyota Raize 1000', model: '2026 Compact SUV', img: '/cars/toyota_raize_1000.png', brand: 'Toyota', bodyStyle: 'SUV' },
    ...
    { name: 'Toyota Harrier Z Leather Package', model: '2026 Luxury SUV', img: '/cars/toyota_harrier_z.png', brand: 'Toyota', bodyStyle: 'SUV' },
    ...
    { name: 'Toyota Alphard Executive Lounge', model: '2026 Flagship MPV', img: '/cars/toyota_alphard.png', brand: 'Toyota', bodyStyle: 'SUV' },
    ...
    { name: 'Toyota Voxy', model: '2026 Luxury MPV', img: '/cars/toyota_voxy.png', brand: 'Toyota', bodyStyle: 'SUV' },
    { name: 'Toyota Noah', model: '2026 Family MPV', img: '/cars/toyota_noah.png', brand: 'Toyota', bodyStyle: 'SUV' },
    ...
    { name: 'Mercedes E350', model: '2026 Executive Sedan', img: '/cars/mercedes_e200.png', brand: 'Mercedes-Benz', bodyStyle: 'Sedan' },
    { name: 'Mercedes E 200', model: '2026 Luxury Sedan', img: '/cars/mercedes_e200.png', brand: 'Mercedes-Benz', bodyStyle: 'Sedan' },
    { name: 'Mercedes S Class All New', model: '2026 Flagship Luxury', img: '/cars/mercedes_s_class.png', brand: 'Mercedes-Benz', bodyStyle: 'Sedan' },
    { name: 'Mercedes AMG G600', model: '2026 Performance Off-roader', img: '/cars/mercedes_amg_gclass.png', brand: 'Mercedes-Benz', bodyStyle: 'SUV' },
    
    // Others
    { name: 'Nissan GTR', model: '2026 Supercar', img: '/cars/nissan_gtr.png', brand: 'Nissan', bodyStyle: 'Coupe' },
    { name: 'Range Rover LWB Auto', model: '2026 Long Wheelbase', img: '/cars/range_rover_lwb.png', brand: 'Land Rover', bodyStyle: 'SUV' },
    { name: 'Ford Cab', model: '2026 Double Cab Pick-up', img: '/cars/ford_f150.png', brand: 'Ford', bodyStyle: 'SUV' },
    { name: 'Lexus ES', model: '2026 Luxury Sedan', img: '/cars/lexus_ls.png', brand: 'Lexus', bodyStyle: 'Sedan' },
